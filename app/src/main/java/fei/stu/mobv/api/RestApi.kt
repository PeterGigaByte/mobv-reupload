package fei.stu.mobv.api

import android.content.Context
import fei.stu.mobv.api.authentication.AuthInterceptor
import fei.stu.mobv.api.authentication.TokenAuthenticator
...
interface RestApi {
    ...
    @Headers("mobv-auth: accept")
    suspend fun addFriendMessage(@Body friendName: UserFriendRequest): Response<Void>

    @POST("contact/delete.php")
    @Headers("mobv-auth: accept")
    suspend fun deleteFriendMessage(@Body friendName: UserFriendRequest): Response<Void>

    @GET("contact/friends.php")
    @Headers("mobv-auth: accept")
    suspend fun friendsList(): Response<List<FriendItemResponse>>

    @GET("contact/list.php")
    @Headers("mobv-auth: accept")
    suspend fun friendsLocationList(): Response<List<FriendLocationItemResponse>>
